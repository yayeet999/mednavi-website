    ...
    <div className="h-full w-full">
      <div className="flex h-[340px] md:h-[480px] w-full">
        ...
        <div className="flex-1 bg-[#103d68] rounded-r-xl flex flex-col overflow-hidden">
          <div className="flex-shrink-0 flex justify-between items-start px-3 pt-1 pb-0 md:px-5 md:pt-2 md:pb-0">
            <h1 className="text-xs md:text-lg text-white font-bold pl-1 md:pl-2 mt-auto mb-1">Your Dental Practice</h1>
            <h2 className="text-sm md:text-[28px] text-white font-medium pr-3 md:pr-8 mt-1">mednavi</h2>
          </div>

          <div className="flex-1 p-1.5 md:p-3">
            <div className="bg-gray-100 rounded-lg h-full flex">
              <div className="w-[40%] md:w-[30%] bg-white rounded-l-lg p-2 md:p-3">
                <PatientMapFilters 
              ...
              <div className="w-[60%] md:w-[70%] bg-white rounded-r-lg">
