...
<div className="flex gap-1 md:gap-2 px-1 md:px-3 mb-2 h-[70px] md:h-[80px]">
      ...
      <div className="grid grid-cols-2 gap-1 md:gap-1 w-full mt-1">
  <div className="bg-white rounded-lg p-1.5 md:p-2.5 shadow-sm h-[100px] md:h-[158px] w-full md:w-[108%] border border-blue-100/50 animate-[slide-up_1.7s_ease-out]">
  ...
  <div className="bg-white rounded-lg p-1.5 md:p-2.5 shadow-sm h-[100px] md:h-[158px] w-[100%] md:w-[92%] md:ml-auto border border-blue-100/50 animate-[slide-up_1.7s_ease-out]">
          <h3 className="text-[8.5px] md:text-[13px] font-medium text-gray-700 mb-1.5">
