    ...
    <div className="h-full w-full overflow-hidden">
      <Tabs defaultValue="demographics" className="h-full flex flex-col">
        ...
        <div className="flex justify-center">
          <div className="bg-[#1E2433] rounded-xl md:min-w-[640px] h-[32px] md:h-[40px] flex items-center px-0.5 md:px-1">
            <TabsList className="flex bg-transparent h-[28px] md:h-[36px] gap-0.5 w-full justify-center">
              <TabsTrigger 
                value="demographics"
                className="rounded-lg h-[24px] md:h-[32px] text-[9px] md:text-xs px-2.5 md:px-6 md:min-w-[210px] font-normal flex items-center justify-center gap-1 md:gap-2
