  ...
  return (
    <div className="flex-1 overflow-y-auto px-1 md:px-3">
      <div className="grid grid-cols-2 gap-2 md:gap-3">
        ...
        <div className="bg-white rounded-lg p-2 md:p-3 shadow-sm h-[104px] md:h-[150px] w-[100%] md:w-[70%] md:ml-auto border border-gray-200">
          <h3 className="text-[8.5px] md:text-[13px] font-medium text-gray-700 mb-2">
            Age Distribution by Gender
          </h3>
          <div className="h-[98px] md:h-[145px] w-full">
