  ...
  return (
    <div className="flex-1 overflow-y-auto pr-1 md:pr-3 h-full flex flex-col">
      ...
      <div className="w-full flex gap-2 md:gap-3 px-2 md:px-4 mb-4">
        ...
        {/* Second through Fifth KPIs - same structure as first */}
        {/* Second KPI */}
        ...
        <div className="flex-1 min-w-0 rounded-lg border border-blue-100/50 shadow-sm p-1 md:p-2 bg-blue-50/30">
          ...
          <div className="flex items-baseline gap-1.5">
            ...
            <span className="hidden md:inline text-[4.1px] md:text-[9.7px] text-blue-900/50">
              Total
            </span>
          </div>
        </div>
        ...
        <div className="flex-[1.05] min-w-0 rounded-lg border border-blue-100/50 shadow-sm p-1 md:p-2 bg-blue-50/35">
          ...
          <div className="flex items-baseline gap-1.5">
            ...
            <span className="hidden md:inline text-[6px] md:text-[10.5px] text-blue-900/70">
              23%
            </span>
            <span className="hidden md:inline text-[4.1px] md:text-[9px] font-medium text-rose-600">
              High
            </span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-1.5 md:p-2.5 shadow-sm h-[100px] md:h-[158px] w-full md:w-[130%] border border-gray-200">
          ...
          <div className="space-y-[6px] md:space-y-[8px] mb-[2px] md:mb-0">
            {retentionData.map((group, idx) => {
              ...
              const widthScale = window.innerWidth < 768 ? 0.7 : 0.91;
                  ...
                  <div className="flex items-center w-full space-x-[2px] md:space-x-[8px]">
                    ...
                    <div className="relative flex-1 h-[12px] md:h-[16px]">
                      ...
                      <span
                        ...
                        style={{
                          left: `calc(${initialWidth} + ${window.innerWidth < 768 ? '4px' : '8px'})`,
                        }}
                      >
                        {retentionRate}%
                      </span>
              ...
              <div className="bg-white rounded-lg p-1.5 md:p-2 mt-1 md:mt-2 shadow-sm">
                ...
                <div className="space-y-1 md:space-y-1.5">
                  {['Cleaning', 'Check-up', 'Filling', 'Root Canal'].map((proc, i) => (
                    <div
                      key={i}
                      className="flex justify-between items-center bg-gray-50 rounded-lg p-1 md:p-1.5"
                    >
