...
export const DashboardContainer = () => {
  ...
  <div className="bg-white rounded-lg p-2 md:p-3 shadow space-y-0.5 md:space-y-1">
  ...
  <div className="bg-white rounded-lg p-2 md:p-3 shadow space-y-0.5 md:space-y-1 w-full md:w-auto md:col-span-1" style={{ width: '110%' }}>
