    ...
    >
      ...
      {selectedIcon === 'financial' && selectedSubData === 'Avg Monthly Production' && (
        <div className="grid grid-rows-2 gap-2 h-full">
          <div className="bg-white rounded-lg p-2 md:p-3 shadow-sm w-[50px] md:w-[700] h-[50px] md:h-[100px]">
          ...
          <div className="bg-white rounded-lg p-2 md:p-3 shadow-sm w-[50px] md:w-[500] h-[50px] md:h-[100px]">
            <MonthlyProductionChart
