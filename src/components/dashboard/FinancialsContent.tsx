...
>
  ...
  <div className="absolute -bottom-1 left-1/2 w-1 h-1 bg-blue-400 rounded-full opacity-75 animate-[glow_2s_ease-in-out_infinite]" />
      ...
      {/* Main Charts */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 px-2 md:px-4 flex-1 h-[220px] md:max-h-[400px]">
        {/* Monthly Production Chart */}
        <div className="bg-white rounded-lg p-1 md:p-2.5 shadow-sm w-full h-[100px] md:h-full border border-gray-200 animate-[slide-up_1.7s_ease-out] overflow-hidden">
          <h3 className="text-[8.5px] md:text-[13px] font-medium text-gray-700 mb-1.5">
            Average Monthly Production/Patient
          </h3>
          <div className="h-[80px] md:h-[200px] w-full">
        ...
        <div className="bg-white rounded-lg p-1 md:p-2.5 shadow-sm w-full h-[100px] md:h-full border border-gray-200 animate-[slide-up_1.7s_ease-out] overflow-hidden">
          ...
          <div className="h-[80px] md:h-[200px] w-full flex items-center">
