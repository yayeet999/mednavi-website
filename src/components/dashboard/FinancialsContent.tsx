...
>
  ...
  <div className="absolute -bottom-1 left-1/2 w-1 h-1 bg-blue-400 rounded-full opacity-75 animate-[glow_2s_ease-in-out_infinite]" />
      ...
      {/* Main Charts */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 px-2 md:px-4 flex-1 max-h-[400px] h-[320px]">
        ...
        <div className="bg-white rounded-lg p-1.5 md:p-2.5 shadow-sm w-full border border-gray-200 animate-[slide-up_1.7s_ease-out] overflow-hidden">
          ...
          <div className="h-[140px] md:h-[200px] w-full flex items-center">
